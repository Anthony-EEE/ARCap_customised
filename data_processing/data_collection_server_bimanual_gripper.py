...
from quest_robot_module import QuestBimanualGripperNoRokokoModule
...
if __name__ == "__main__":
    ...
    quest = QuestBimanualGripperNoRokokoModule(VR_HOST, LOCAL_HOST, POSE_CMD_PORT, IK_RESULT_PORT, vis_sp=None)
        ...
        try:
            ...
            if wrist_left is not None and wrist_right is not None:
                ...
                arm_q, hand_q, wrist_pos, wrist_orn = quest.solve_system_world(wrist_left_pos, wrist_left_orn, 
                                                                               wrist_right_pos, wrist_right_orn) # arm_q and hand_q should be concatenation of left and right
